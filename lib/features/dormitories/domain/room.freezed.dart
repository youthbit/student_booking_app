...
class _$_Room implements _Room {
  ...
  @override
  String toString() {
    return 'Room(id: $id, description: $description, type: $type, price: $price, photos: $photos)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, description, type, price,
...
abstract class _Room implements Room {
  const factory _Room(
      ...
      required final List<String> photos}) = _$_Room;
