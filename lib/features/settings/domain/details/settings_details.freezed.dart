...
abstract class $SettingsDetailsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String currentLanguage, String themeMode});
}
...
class _$_SettingsDetails implements _SettingsDetails {
  const _$_SettingsDetails(
      {required this.currentLanguage, required this.themeMode});
  ...
  @override
  String toString() {
    return 'SettingsDetails(currentLanguage: $currentLanguage, themeMode: $themeMode)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, currentLanguage, themeMode);
