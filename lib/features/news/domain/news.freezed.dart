...
abstract class $NewsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, String cover, String content});
}
...
class _$_News extends _News {
  ...
  @override
  String toString() {
    return 'News(id: $id, title: $title, cover: $cover, content: $content)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, cover, content);
